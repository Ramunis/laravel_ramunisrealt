...
<html lang="en">
  <head>
    ...
    <title>Каталог новостроек</title>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/newbuild">Новостройки</a>
            </li>
        <li class="nav-item">
...
<main>
  ...
  <form method="get" action="{{ route('filtre') }}" class="needs-validation" novalidate>
 <div class="form-row">
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    <br><div class="container">
        <h1 class="h2">Поиск новостроек</h1>
        <form method="get" action="{{ route('findnew') }}"">
    ...
    <br><div class="container">
    <a class="alert alert-primary" href="{{ route('sortmaxnew') }}">Самые дешёвые</a>
    <a class="alert alert-primary" href="{{ route('sortminnew') }}">Самые дорогие</a>
    <div>
