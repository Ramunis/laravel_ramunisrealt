...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      ...
      <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/newbuy">Продать</a>
          </li>
      <li class="nav-item">
...
<main>
      ...
      <h2>Новое объявление продажи</h2>
      <p class="lead">Объявление будет размещено в каталоге продажи и доступно для просмотра пользователям сервиса.</p>
    </div>
    ...
    <div class="row g-5">
      ...
      <form class="d-flex" action="{{ route('buyed') }}" method="post">
        @csrf
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="address" class="form-label">Адрес <span class="text-muted">(Optional)</span></label>
  ...
  <footer class="container">
    <p class="float-end"><a href="/newbuy">Back to top</a></p>
