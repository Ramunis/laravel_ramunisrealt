...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    @if(count($contractes))
  <br><h1 class="h2">На месяце у меня купили</h1>
...
<?php else: print '<h2>На месяце никто не купил<h2>'?>
@endif


@if(count($archivs))
<br><h1 class="h2">На месяце риелтор одобрил сделки</h1>
<table class="table table-striped">
<thead>
<tr>
<th scope="col">ID</th>
...
<?php else: print '<h2>Намесяце риелтор не одобрял<h2>'?>
@endif
