    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/buy">Купить</a>
          </li>
          <li class="nav-item">
...
<main>
  ...
  <form method="get" action="{{ route('filtere') }}" class="needs-validation" novalidate>
 <div class="form-row">
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    <br><div class="container">
        <h1 class="h2">Поиск объявлений по продаже недвижимости</h1>
        <form method="get" action="{{ route('find') }}"">
              <input type="text" class="form-control" id="q" name="q" placeholder="Поиск по адресу...">
              <button type="submit" class="btn btn-primary btn-block">Поиск</button>
        </form>
    </div>

    <br><div class="container">
    <a class="alert alert-primary" href="{{ route('sortmaxbuy') }}">Самые дешёвые</a>
    <a class="alert alert-primary" href="{{ route('sortminbuy') }}">Самые дорогие</a>
    <div>

      <br><div class="container">
      <a href="{{ route('onem') }}">До 1000000$</a>
      <a href="{{ route('twom') }}">До 3000000$</a>
      <a href="{{ route('threem')}}">До 6000000$</a>
      <a href="{{ route('fourm')}}">До 10000000$</a>
      <div>
...
@endif
  ...
  <footer class="container">
    <p class="float-end"><a href="/buy">Back to top</a></p>
