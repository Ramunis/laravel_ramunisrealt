...
<div class="container">
      ...
      <p class="lead">Введите код подтверждения из email.</p>
    </div>
    ...
    <div class="row g-5">
      ...
      <form class="d-flex" action="{{ route('reset') }}" method="post">
        @csrf
      ...
      <div class="col-md-7 col-lg-8">
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              <label for="address" class="form-label">Введите Код <span class="text-muted"></span></label>
