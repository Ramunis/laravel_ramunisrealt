...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      ...
      <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/affare">Текущие сделки</a>
          </li>
        </li>
    <li class="nav-item">
...
<main>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{ route('user', $contract->realtor) }}"><button class="btn btn-warning">-></button></a></td>
    </tr>
    @endforeach
  </tbody>
</table>
    ...
    <?php else: print '<h2>Покупки не найдены<h2>'?>
@endif

     @if(count($contrs))
	   <br><h1 class="h2">У меня покупают</h1>
     <table class="table table-striped">
   <thead>
     <tr>
       <th scope="col">ID</th>
   ...
   {{$contrs->links()}}
     <?php else: print '<h2>Никто ещё не купил<h2>'?>
 @endif
  ...
  <footer class="container">
    <p class="float-end"><a href="/affare">Back to top</a></p>
