...
<main>
  ...
  <div class="container">
      ...
      <p class="lead">Код подтверждения отправлен на email.</p>
    </div>
    ...
    <div class="row g-5">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">Регистрация аккаунта</h6>
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">Завершение регистрация</h6>
              <small class="text-muted">перенаправление на страницу приветствия</small>
            </div>
            <span class="text-muted"></span>
          </li>
        </ul>
      ...
      <form class="d-flex" action="{{ route('confirm') }}" method="post">
        @csrf

      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Подтвердите email</h4>
        <form class="needs-validation" novalidate>
          <div class="row g-3">

            <div class="col-12">
              <label for="address" class="form-label">Введите код <span class="text-muted">(с почты)</span></label>
              <input type="text" class="form-control" id="code" name="code" placeholder="xxxxxx">
            </div>
