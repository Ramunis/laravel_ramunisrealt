...
<main>
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <br><div class="container">
      ...
      @if(count($buye))
	  <br><h1 class="h2">Контакты продажи</h1>
  ...
  <tbody>
    ...
    {{$buye->links()}}
<?php else: print '<h2>Контракты продажи не найдены<h2>'?>
@endif

     @if(count($ibuyer))
	   <br><h1 class="h2">Контракты купли</h1>
     <table class="table table-striped">
   <thead>
     <tr>
       <th scope="col">ID</th>
   ...
   {{$ibuyer->links()}}
 <?php else: print '<h2>Контракты купли не найдены<h2>'?>
 @endif

   &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<a href="/regedit">Вернуться к аренде</a>
  ...
  <footer class="container">
    <p class="float-end"><a href="/regeditnext">Back to top</a></p>
