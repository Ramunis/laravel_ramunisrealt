...
<main>
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
      ...
      <a class="link-secondary" href="/events" aria-label="Add a new report">
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    @if(count($contractes))
  <br><h1 class="h2">Сегодня у меня купили</h1>
...
<tbody>
  ...
  <?php else: print '<h2>Сегодня никто не купил<h2>'?>
@endif


@if(count($archivs))
<br><h1 class="h2">Сегодня риелтор одобрил сделки</h1>
<table class="table table-striped">
<thead>
<tr>
<th scope="col">ID</th>
...
<?php else: print '<h2>Сегодня риелтор не одобрял<h2>'?>
@endif
